				...
				<div className='aboutme-container'>
					...
					<div className='aboutme-text-container'>
						<p>
							...
							<br />
							<br />
							After 6 years of my life in the recording and video game industry,
							I finally realized that I finally found it fun to keep asking lots
							of questions, tweaking things and feeling the victory of solving
							problems. So I said bye-bye to my vinyl boxes and the latest
							trendy AAAs and I decided to convert myself into a web developer!
							<br />
							<br />
							<br />
